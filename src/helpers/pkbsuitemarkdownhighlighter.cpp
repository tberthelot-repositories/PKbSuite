...
#include "pkbsuitemarkdownhighlighter.h"
 ...
 * @param text
 */
void PKbSuiteMarkdownHighlighter::highlightBlock(const QString &text) {
 ...
 * @param text
 */
void PKbSuiteMarkdownHighlighter::highlightSpellChecking(const QString &text) {
    if (text.length() < 2) {
        return;
    }
