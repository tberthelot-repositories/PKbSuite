#include "pkbsuitemarkdowntextedit.h"
...
PKbSuiteMarkdownTextEdit::PKbSuiteMarkdownTextEdit(QWidget *parent)
    ...
    connect(this, &PKbSuiteMarkdownTextEdit::cursorPositionChanged, this,
            &PKbSuiteMarkdownTextEdit::highlightCurrentLine);
 ...
 * @param styles
 */
void PKbSuiteMarkdownTextEdit::setFormatStyle(
 ...
 * @param fontSize
 */
void PKbSuiteMarkdownTextEdit::overrideFontSizeStyle(int fontSize) {
    QSettings settings;
    ...
    if (overrideInterfaceFontSize) {
        ...
        stylesheet +=
            QStringLiteral(
                QOWNNOTESMARKDOWNTEXTEDIT_OVERRIDE_FONT_SIZE_STYLESHEET_PRE_STRING) +
            "PKbSuiteMarkdownTextEdit {font-size: " +
 ...
 */
void PKbSuiteMarkdownTextEdit::setStyles() {
 ...
 */
int PKbSuiteMarkdownTextEdit::modifyFontSize(FontModificationMode mode) {
    QSettings settings;
 ...
 */
void PKbSuiteMarkdownTextEdit::openUrl(QString urlString) {
...
// void PKbSuiteMarkdownTextEdit::setViewportMargins(
 ...
 */
void PKbSuiteMarkdownTextEdit::setPaperMargins(int width) {
    QSettings settings;
 ...
 */
void PKbSuiteMarkdownTextEdit::setMainWindow(MainWindow *mainWindow) {
 ...
 */
void PKbSuiteMarkdownTextEdit::updateSettings() {
 ...
 */
void PKbSuiteMarkdownTextEdit::highlightCurrentLine() {
    QSettings settings;
...
bool PKbSuiteMarkdownTextEdit::onContextMenuEvent(QContextMenuEvent *event) {
